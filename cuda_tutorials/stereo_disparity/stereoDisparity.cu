...
////////////////////////////////////////////////////////////////////////////////
void
apply_disp_est(unsigned char* left, unsigned char* right, int h, int w)
{
    runTest(left, right, h, w);
}
...
////////////////////////////////////////////////////////////////////////////////
void
runTest(unsigned char* left, unsigned char* right, unsigned int height, unsigned int width)
{
   ...
   // }
    ...
    unsigned char *h_img0 = left;
    unsigned char *h_img1 = right;
